                ...
                <tr key={tarea.id} style={{ textAlign: "center", borderBottom: "1px solid #ddd" }}>
                  ...
                  <td>
                    {tarea.archivo_entrega ? (
                      <a href={getArchivoURL(tarea.archivo_entrega)} target="_blank" rel="noopener noreferrer">
                        Descargar
                      </a>
                    ) : (
                      "No entregado"
                  ...
                  <td>
                    {tarea.estado === "entregada" ? (
                      <div style={{ display: "flex", gap: "0.5rem", justifyContent: "center" }}>
                        <Button onClick={() => handleCalificar(tarea.id, "correcta")}>Correcta</Button>
                        <Button onClick={() => handleCalificar(tarea.id, "tarde")}>Tarde</Button>
                        <Button onClick={() => handleCalificar(tarea.id, "con_errores")}>Con Errores</Button>
                      </div>
                    ) : (
                      "-"
                    )}
